  ...
  return (
    <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[1.4fr_0.8fr] lg:px-10">
      ...
      <aside className="h-fit rounded-3xl border border-border bg-surface p-6 lg:sticky lg:top-28">
        ...
        <Link
          href="/checkout"
          className="mt-8 inline-flex h-12 w-full items-center justify-center rounded-full bg-accent px-6 text-sm font-semibold text-accent-foreground transition-colors hover:bg-[#c41010] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
          Checkout
        </Link>
        <Link
        ...
        <p className="mt-4 text-xs leading-5 text-muted">
          Bag is saved on this device. Payment stays preview until Razorpay is
          connected.
        </p>
      </aside>
    </div>
